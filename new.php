...
<div id="container">
    ...
    <div id="profil">
        ...
        <ul>
            <li><img id="user" src="icons/user.png"></li>
            <li id="text"><a href="gestion_membres/inscription.php">NOUVEAU PROFIL</a></li>
        </ul>
        <ul>
            <li><img id="user" src="icons/user-plus.png"></li>
            <li id="text"><a href="gestion_membres/login.php">CONNEXION</a></li>
        </ul>
    </div>
